...
Section "Register .bxrc Extension" SecExtension
  ...
  WriteRegStr HKCR "BochsConfigFile\shell\Debugger\command" "" '"$INSTDIR\Bochs.exe" -dbg_gui -f "%1"'
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\i440fx.bin"
  Delete "$INSTDIR\README-i440fx"
  Delete "$INSTDIR\RELEASEX64_OVMF.fd"
  Delete "$INSTDIR\OVMF-pure-efi.fd"
